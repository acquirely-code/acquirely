...
export const metadata = {
  title: "You're Booked | Acquirely Publishers",
  description:
    "Thank you for booking your call with Acquirely. Here's what happens next.",
  robots: {
    index: false,
    follow: false,
  },
...
const nextSteps = [
  {
    ...
    description:
      "Calendar invite with the Zoom link, plus a WhatsApp reminder before we speak.",
  },
  {
    title: "On the call — a real diagnosis",
    description:
      "We show you why the right decision-makers are not seeing you, and map the first campaign to get principals and directors booking meetings with you. A working session, not a pitch.",
  },
];

export default function PublishersThankYouPage() {
  return (
    <main className="min-h-screen bg-white text-[#172554]">
      ...
      <section className="relative overflow-hidden bg-[radial-gradient(520px_300px_at_85%_15%,rgba(96,165,250,0.24),transparent_65%),linear-gradient(145deg,#fff_0%,#f5f9ff_58%,#eff6ff_100%)]">
        <div className="mx-auto flex w-[min(720px,92vw)] flex-col items-center px-0 py-10 sm:py-14">
          <Image
            src={acquirelyLogo}
            alt="Acquirely"
          ...
          <p className="mt-4 max-w-[44ch] text-center text-[clamp(1rem,2vw,1.12rem)] leading-7 text-[#64748b]">
            ...
            are on their way. Check your inbox and spam folder just in case.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-8 sm:py-10">
        <div className="mx-auto flex w-[min(720px,92vw)] flex-col gap-6">
          <div className="rounded-[28px] border border-[#dbe7f5] bg-white p-6 shadow-[0_14px_32px_-24px_rgba(37,99,235,0.24)] sm:p-8">
            ...
            <div className="flex flex-col gap-5">
              {nextSteps.map((step, index) => (
                <div
                  key={step.title}
                  className="flex items-start gap-4 rounded-2xl border border-[#e7eef9] bg-[#fbfdff] p-4 sm:p-5"
                >
                  ...
                  <div>
                    <h2 className="text-lg font-extrabold leading-6 tracking-[-0.02em] text-[#172554]">
                      {step.title}
                    </h2>
                    <p className="mt-1 text-[0.97rem] leading-7 text-[#64748b]">
                      {step.description}
                    </p>
                  </div>
                </div>
          ...
          <div className="rounded-[28px] border border-[#cfe1ff] bg-[linear-gradient(180deg,#f8fbff,#f3f8ff)] p-7 text-center shadow-[0_14px_32px_-24px_rgba(37,99,235,0.24)] sm:p-8">
            ...
            <p className="mx-auto mt-3 max-w-[52ch] text-[1rem] leading-7 text-[#52647e]">
              And to understanding how we can help you become more visible and
              reach the decision-makers you&apos;re after.
            </p>
          </div>
